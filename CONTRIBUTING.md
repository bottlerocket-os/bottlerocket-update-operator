...
When filing an issue, please check [existing open](https://github.com/bottlerocket-os/bottlerocket-update-operator/issues) and [closed](https://github.com/bottlerocket-os/bottlerocket-update-operator/issues?q=is%3Aissue+is%3Aclosed) issues to make sure somebody else hasn't already reported the issue.
...
3. You check existing [open](https://github.com/bottlerocket-os/bottlerocket-update-operator/pulls) and [merged](https://github.com/bottlerocket-os/bottlerocket-update-operator/pulls?q=is%3Apr+is%3Aclosed) pull requests to make sure someone else hasn't addressed the problem already.
